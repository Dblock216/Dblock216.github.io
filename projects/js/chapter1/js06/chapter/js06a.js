 ...
 */
      ...
      window.addEventListener("load", function(){
            ...
            function calcOrder(){
                  ...
                  //protection plan
                  let pValue= document.querySelector('input[name="plan"]:checked').value;
                  let pCost=pValue * quantity;
                  orderForm.elements.planCost.value = pCost.toLocaleString("en-US",{style: "currency", currency: "USD"});

                  //subtotal
                  let subtotal = modelCost + pCost;
